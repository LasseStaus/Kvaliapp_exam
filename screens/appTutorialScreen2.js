...
const AppTutorialScreen2 = props => {
 ...
 return (
    <View style={styles.container}>
   ...
   }} source = {require('./../assets/imgs/onboardingimg3.png')} />
        </View>
      ...
      <View style={styles.circleWrap}> 
       ...
       <View style={styles.outerCircle3}>
        ...
        <TouchableOpacity onPress={ () => props.navigation.navigate('AppTutorialScreen3') }>
...
export default AppTutorialScreen2;